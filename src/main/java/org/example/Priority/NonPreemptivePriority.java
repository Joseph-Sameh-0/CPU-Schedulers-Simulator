...
public class NonPreemptivePriority {
  ...
  public static void simulatePriority(
    ...
    while (completedProcesses < processes.size()) {
      ...
      process.turnaroundTime =
        currentTime - contextSwitchTime - process.arrivalTime;
  ...
  public static void main() {
    ...
    try (
      BufferedReader br = new BufferedReader(new FileReader("src/test_cases/Process.txt"))
    ) {
